...
export const CoursesList = ({
  ...
  return (
    <div>
      ...
      {items.length === 0 && (
        <div className="flex flex-col items-center justify-center text-center text-4xl text-muted-foreground mt-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="7em" height="7em" viewBox="0 0 24 24">
            <path fill="currentColor" d="M12 20.028V18H8v2.028c0 .277 0 .416.095.472c.095.056.224-.006.484-.13l1.242-.593c.088-.042.132-.063.179-.063c.047 0 .091.02.179.063l1.242.593c.26.124.39.186.484.13c.095-.056.095-.195.095-.472" opacity="0.5" />
